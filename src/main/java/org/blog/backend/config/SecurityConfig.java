...
import org.blog.backend.exception.RestExceptionFilter;
import org.blog.backend.service.UserService;
import org.blog.backend.dto.UserDTO;
import org.blog.backend.filter.JwtFilter;
...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests(requests -> requests
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/likes/**").hasAnyRole("USER", "ADMIN", "STAFF")
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/announcements/**").hasAnyRole("ADMIN","STAFF","USER")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/announcements/**").hasAnyRole("ADMIN")
